  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="#" class="b-brand text-primary">
        ...
        <img src="{{ asset('dist/assets/images/logo-dark.svg') }}" class="img-fluid" alt="logo">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="{{ route('atividades.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-screen-share"></i></span>
            <span class="pc-mtext">Atividades</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="{{ route('usuarios.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-users"></i></span>
            <span class="pc-mtext">Usuários</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="{{ route('departamentos.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-grid-dots"></i></span>
            <span class="pc-mtext">Departamentos</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="{{ route('categorias.index') }}" class="pc-link">
